...
extension NetworkManager {
    ...
    func getAllPlacesByCityId(cityId: Int) async throws -> DecodedPlaces {
        var urlComponents: URLComponents {
            var components = URLComponents()
            components.scheme = scheme
            components.host = host
    ...
    func getPlaceInfoById(placeId: Int) async throws -> DecodedPlace {
        var urlComponents: URLComponents {
            var components = URLComponents()
            components.scheme = scheme
            components.host = host
    ...
    func getAllPlacesByUserLocation(latitude: Double, longitude: Double, radius: Int = 10) async throws -> DecodedPlaces {
        var urlComponents: URLComponents {
            var components = URLComponents()
            components.scheme = scheme
            components.host = host
